...

{
	...
	// Wire up timers.
	//
	MissionTimerDisplay.Init(&TimersMnACircuitBraker, &TimersMnBCircuitBraker, &NumericRotarySwitch, &LightingNumIntLMDCCB, NULL, &CentralTimingEquipMNACB, &CentralTimingEquipMNBCB);
	MissionTimer306Display.Init(&TimersMnACircuitBraker, &TimersMnBCircuitBraker, &Panel100NumericRotarySwitch, &LightingNumIntLEBCB, NULL, &CentralTimingEquipMNACB, &CentralTimingEquipMNBCB);
