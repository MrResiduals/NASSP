...
bool LEM::clbkLoadPanel (int id) {
	...
	case LMPANEL_MAIN: // LEM Main panel
		...
		oapiRegisterPanelArea (AID_MISSION_CLOCK,					_R( 663,  285,  836,  310), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_MPS_FUEL_QUANTITY_INDICATOR,		_R(1064,  297, 1110,  327), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_MPS_HELIUM_PRESS_INDICATOR,		_R(1197,  285, 1290,  310), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND);
	...
	case LMPANEL_LEFTWINDOW: // LEM Left Window
		...
		oapiRegisterPanelArea(AID_MISSION_CLOCK,					_R(1440,  106, 1600,  130), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea(AID_EVENT_TIMER,						_R(1668,  106, 1768,  130), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea(AID_MPS_FUEL_QUANTITY_INDICATOR,		_R(1838,  117, 1884,  141), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		// 3 pos Engine Arm Lever
	...
	case LMPANEL_LPDWINDOW: // LPD Window
		...
		oapiRegisterPanelArea(AID_MPS_OXID_QUANTITY_INDICATOR,		_R(1432,  131, 1478,  155), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND);
