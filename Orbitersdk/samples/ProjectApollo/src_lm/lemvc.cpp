...
void LEM::RegisterActiveAreas()
{
	...
	oapiVCRegisterArea(AID_VC_MISSION_CLOCK, _R(36*TexMul, 259*TexMul, 210*TexMul, 284*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
	...
	oapiVCRegisterArea(AID_VC_MPS_HELIUM_PRESS_INDICATOR, _R(575*TexMul, 259*TexMul, 668*TexMul, 284*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
